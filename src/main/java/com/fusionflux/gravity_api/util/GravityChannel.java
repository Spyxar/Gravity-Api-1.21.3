...
//        client.execute(() -> {
//            getGravityComponent(client.world, entityId).ifPresent(packet::run);
//        });
//    }
//
...
//            OVERWRITE_GRAVITY.sendToClient(entity, new OverwriteGravityPacket(entity.getId(), gc.getGravity(), initialGravity), mode);
//            DEFAULT_GRAVITY.sendToClient(entity, new DefaultGravityPacket(entity.getId(),gc.getDefaultGravityDirection(), rp, initialGravity), mode);
//            INVERT_GRAVITY.sendToClient(entity, new InvertGravityPacket(entity.getId(),gc.getInvertGravity(), rp, initialGravity), mode);
//            DEFAULT_GRAVITY_STRENGTH.sendToClient(entity, new DefaultGravityStrengthPacket(entity.getId(),gc.getGravityStrength()), mode);
//        });
//    }
//
