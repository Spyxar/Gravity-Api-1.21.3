...
public abstract class LivingEntityMixin extends Entity {
    ...
    //ToDo: Do this for travelInFluid, travelGliding and travelMidAir
//    @Redirect(
//            method = "travel",
//            at = @At(
//                    value = "INVOKE",
...
//    }
    ...
    @Redirect(
            method = "canSee(Lnet/minecraft/entity/Entity;Lnet/minecraft/world/RaycastContext$ShapeType;Lnet/minecraft/world/RaycastContext$FluidHandling;Ljava/util/function/DoubleSupplier;)Z",
            at = @At(
                    value = "NEW",
...
//            )
//    )
//    private double redirect_damage_getX_0(LivingEntity instance) {
//        Direction gravityDirection = GravityChangerAPI.getGravityDirection((Entity)(Object)this);
//        if(gravityDirection == Direction.DOWN) {
//            if(GravityChangerAPI.getGravityDirection(instance) == Direction.DOWN) {
//                return instance.getX();
//            } else {
//                return instance.getEyePos().x;
//            }
//        }
//
//        return RotationUtil.vecWorldToPlayer(instance.getEyePos(), gravityDirection).x;
//    }
//
//    //ToDo: Check
//    @Redirect(
...
//    }
    ...
    private BlockPos modify_baseTick(LivingEntity instance)
    {
        return new BlockPos((int) this.getEyePos().x, (int) this.getEyePos().y, (int) this.getEyePos().z);
    }
