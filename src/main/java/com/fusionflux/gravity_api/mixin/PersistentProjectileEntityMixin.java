...
//ToDo: Check
    ...
    private static void modifyargs_init_init_0(Args args, EntityType<? extends PersistentProjectileEntity> type, LivingEntity owner, World world, ItemStack stack, @Nullable ItemStack shotFrom) {
