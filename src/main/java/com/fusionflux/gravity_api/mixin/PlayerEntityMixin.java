...
//    @Shadow public abstract EntityDimensions getDimensions(EntityPose pose);
    ...
    //ToDo: Check
    @Shadow protected abstract boolean method_30263(float f);
...
//
    ...
    //ToDo: dropItem code was moved somewhere else
//    @Redirect(
...
//        if (!this.abilities.flying && (type == MovementType.SELF || type == MovementType.PLAYER) && this.clipAtLedge() && this.isAboveGround()) {
        if (!this.abilities.flying && (type == MovementType.SELF || type == MovementType.PLAYER) && this.clipAtLedge() && this.method_30263(this.getStepHeight())) {
